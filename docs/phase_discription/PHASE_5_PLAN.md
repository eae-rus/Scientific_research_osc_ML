...
- [ ] Выполнить `pdr_labels_v5`/`pdr_analysis_v5` с условием мощностных органов
...
- [ ] Подтвердить пилотные CFG/DAT в целевой программе, выполнить ручную разметку
  и зафиксировать формат обратного импорта.
