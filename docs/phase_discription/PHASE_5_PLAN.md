...
- [ ] Дождаться полного RTDS-экспорта, проверить его в осциллоскопе и перенести
  принятые пары в pdr_rtds_verified. Сохранить опыт контрольным, не дообучать по нему.
