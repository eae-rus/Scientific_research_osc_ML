...
from osc_tools.ml.models import (
    ...
    SimpleKAN, ConvKAN, PhysicsKAN, PhysicsKANConditional, cPhysicsKAN, rPhysicsKAN,
    PhysicsKANv2, cPhysicsKANv2, rPhysicsKANv2, rKANv2, AutoEncoder
)
...
class ExperimentRunner:
    ...
    def _init_model(self):
        ...
        elif name == 'PhysicsKANv2':
            model = PhysicsKANv2(**params)
        elif name == 'cPhysicsKANv2':
            model = cPhysicsKANv2(**params)
        elif name == 'rPhysicsKANv2':
            model = rPhysicsKANv2(**params)
        elif name == 'rKANv2':
            model = rKANv2(**params)
