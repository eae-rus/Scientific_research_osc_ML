...
def parse_experiment_name(exp_name: str) -> Dict[str, str]:
    ...
    # Модели: SimpleMLP, SimpleCNN, SimpleKAN, ConvKAN, PhysicsKAN, cPhysicsKAN, rPhysicsKAN, ResNet1D, Hierarchical*, *v2
    model_pattern = r'(SimpleMLP|SimpleCNN|SimpleKAN|ConvKAN|PhysicsKAN|cPhysicsKAN|rPhysicsKAN|rKANv2|PhysicsKANv2|cPhysicsKANv2|rPhysicsKANv2|ResNet1D|HierarchicalMLP|HierarchicalCNN|HierarchicalConvKAN|HierarchicalPhysicsKAN|HierarchicalSimpleKAN|HierarchicalResNet)'
